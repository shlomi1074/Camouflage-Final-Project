...
def run():
  ...
  """
  tmp_files_path = r"..\Code\Models\mAP\tmp_files"
  if not os.path.exists(tmp_files_path): # if it doesn't exist already
    os.makedirs(tmp_files_path)
  results_files_path = r"..\Code\Models\mAP\results"
  ...
  ground_truth_files_list = glob.glob(r"..\Code\Models\mAP\ground-truth/*.txt")
  ...
  for txt_file in ground_truth_files_list:
    ...
    if not os.path.exists(r'..\Code\Models\mAP\predicted/' + file_id + ".txt"):
  ...
  predicted_files_list = glob.glob(r'..\Code\Models\mAP\predicted/*.txt')
  ...
  for class_index, class_name in enumerate(gt_classes):
    ...
    for txt_file in predicted_files_list:
      ...
      file_id = os.path.basename(os.path.normpath(file_id))
      if class_index == 0:
        if not os.path.exists(r'..\Code\Models\mAP\ground-truth/' + file_id + ".txt"):
